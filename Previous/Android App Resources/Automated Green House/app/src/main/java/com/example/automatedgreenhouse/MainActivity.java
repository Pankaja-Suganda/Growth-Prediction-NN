...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStop() {
        super.onStop();
        Control_Data.DashBoard dash = new Control_Data.DashBoard();
        Intent intent = new Intent(this, Control_Data.DashBoard.class);
            ...
            public void onClick(View v) {
                ...
                if(isInternetConnection()) {
                    ...
                    if (email.isEmpty() && Password.isEmpty()) {
                        ...
                        btnLogin.setText(Login.getState().toString());
                        if(Login.getState()){
